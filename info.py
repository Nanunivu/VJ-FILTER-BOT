...
API_ID = int(environ.get('API_ID', '22467215'))
API_HASH = environ.get('API_HASH', 'e86779c04d4461c041e02522d0c1c22f')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002316880819'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5746084022').split()]

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002839887078').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002839887078') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002379007808')).split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://iramu3023_db_user:eztQHxvvhXNjjt1V@cluster0.tvmzpmz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # IF Multiple Database Is False Then Fill Only This Database Url.
