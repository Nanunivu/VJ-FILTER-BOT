...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002162343543').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002162343543') # give your force subscribe channel id here else leave it blank
